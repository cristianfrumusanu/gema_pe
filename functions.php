...
function gema_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'gema' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'gema_custom_background_args', array(
...
function gema_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'gema_content_width', 640 );
}
...
function gema_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'gema' ),
...
function gema_scripts() {
	wp_enqueue_style( 'gema-style', get_stylesheet_uri() );

	wp_enqueue_script( 'gema-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'gema-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
